...
function useFilters () {
    ...
    function filterCountries(countries) {
        ...
        const filtered = order.filter(country => {
            const query = filters.query === '' || country.name.common.toLowerCase().startsWith(filters.query.toLowerCase()) || country.region?.toLowerCase().startsWith(filters.query.toLowerCase()) || country.subregion?.toLowerCase().startsWith(filters.query.toLowerCase());
